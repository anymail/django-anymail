...
def derive_public_webhook_key(private_key) -> str:
    """Derive public"""
...
def sign(private_key, timestamp: str, message: str):
...
class _ClientWithSendGridSignature(ClientWithCsrfChecks):
    ...
    def post(self, *args, **kwargs):
        ...
        signature = b64encode(
            sign(self.private_key, timestamp=timestamp, message=kwargs["data"])
        )
        ...
        with override_settings(ANYMAIL={"SENDGRID_WEBHOOK_KEY": webhook_key}):
